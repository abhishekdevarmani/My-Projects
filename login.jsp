...
<div class="w3layouts-main">
	<h2>Secured Login</h2>
		<form action="logchk.jsp" method="post">
			<input type="text" autocomplete="off" autofocus="on" class="ggg" name="uname" placeholder="Username" required="">
			<input type="password" class="ggg" name="pass" placeholder="Password" required="">
			
				<div class="clearfix"></div>
				<input type="submit" value="Sign In" name="login">
		</form>
		<p><a href="fpass1.jsp">Forgot Password?</a> | <a href="wwa_regf.jsp">Organization Register</a> | <a href="user_regf.jsp">User Register</a> </p>
</div>
</div>
