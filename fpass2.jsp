...
<div class="w3layouts-main">
	<h2>Forgot Password</h2>
		<form action="resetpassf.jsp" method="post">
		 <input type="hidden" name="un" value="<%=un%>"/>
			<input type="text" autocomplete="off" class="ggg" name="sq" value="<%=rs.getString("s_qstn")%>" readonly="" placeholder="Security Question" required="">
			<input type="password" autocomplete="off" autofocus="on" class="ggg" name="sa" placeholder="Security Answer" required="">
